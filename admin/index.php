...
echo "<script type='text/javascript'> document.location = 'dashboard.php'; </script>";
  ...
  echo "<script>alert('Грешни данни');</script>";
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold mt-4x">Вход за Админ</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">

									<label for="" class="text-uppercase text-sm">Потребителско име </label>
