...
header('location:index.php');
  ...
  {	
    ...
    $query->execute(); 
	$msg="Обратната връзка е изпратена";
  }
?>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12">
                            <h2>Отговори на обратна връзка с Админ</h2>
...
<div class="form-group">
	<label class="col-sm-2 control-label">Съобщение<span style="color:red">*</span></label>
	<div class="col-sm-6">
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<button class="btn btn-primary" name="submit" type="submit">Изпрати отговор</button>
	</div>
</div>
