...
<head>
	...
	<title>Редактиране на Admin</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Редактиране на Админ</h3>
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Промяна на информацията</div>
...
<label class="col-sm-2 control-label">Юзърнейм<span style="color:red">*</span></label>
<div class="col-sm-4">
