...
<head>
	...
	<title>Изпращане на отзив</title>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-12">
                            <h2>Изразете мнението си свободно</h2>
								<div class="panel panel-default">
									<div class="panel-heading">Форма за обратна връзка</div>
<?php if($error){?><div class="errorWrap"><strong>Неуспешно</strong>:<?php echo htmlentities($error); ?> </div><?php } 
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Заглавие<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="text" name="title" class="form-control" required>
	</div>

	<label class="col-sm-2 control-label">Прикачете файл<span style="color:red"></span></label>
	<div class="col-sm-4">
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<button class="btn btn-primary" name="submit" type="submit">Изпрати</button>
	</div>
</div>
