...
$chngpwd1->execute();
$msg="Променихте паролата си успешно";
}
else {
$error="Сегашната ви парола е невалидна.";	
}
}
?>
...
{
alert("Новата парола и потвърждението й не съвпадат");
			...
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Изберете сигурна парола за вашата лична защита</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>Грешка</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Потвърдете паролата</label>
												<div class="col-sm-8">
